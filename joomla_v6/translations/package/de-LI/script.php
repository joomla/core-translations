...
class Pkg_deLIInstallerScript extends InstallerScript
{
    ...
    public function __construct()
    {
        ...
        $this->deleteFiles = [
            ...
            '/administrator/language/de-LI/plg_captcha_recaptcha.ini',
            '/administrator/language/de-LI/plg_captcha_recaptcha.sys.ini',
            ...
            '/administrator/language/de-LI/plg_system_logrotation.ini',
            '/administrator/language/de-LI/plg_system_logrotation.sys.ini',
            '/administrator/language/de-LI/plg_system_sessiongc.ini',
            '/administrator/language/de-LI/plg_system_sessiongc.sys.ini',
            '/administrator/language/de-LI/plg_system_updatenotification.ini',
            '/administrator/language/de-LI/plg_system_updatenotification.sys.ini',
            '/administrator/language/de-LI/plg_task_demotasks.ini',
            '/administrator/language/de-LI/plg_task_demotasks.sys.ini',
            '/administrator/language/de-LI/plg_twofactorauth_totp.ini',
            '/administrator/language/de-LI/plg_twofactorauth_totp.sys.ini',
            '/administrator/language/de-LI/plg_twofactorauth_yubikey.ini',
            '/administrator/language/de-LI/plg_twofactorauth_yubikey.sys.ini',
            '/language/de-LI/lib_simplepie.sys.ini',
            // Old files from Joomla 5 language packs
            '/administrator/language/de-LI/plg_captcha_recaptcha_invisible.ini',
            '/administrator/language/de-LI/plg_captcha_recaptcha_invisible.sys.ini',
            '/administrator/language/de-LI/plg_behaviour_compat.ini',
            '/administrator/language/de-LI/plg_behaviour_compat.sys.ini',
            'administrator/language/de-LI/guidedtours.joomla_whatsnew_5_2.ini',
            'administrator/language/de-LI/guidedtours.joomla_whatsnew_5_2_steps.ini',
            'administrator/language/de-LI/guidedtours.joomla_whatsnew_5_3.ini',
            'administrator/language/de-LI/guidedtours.joomla_whatsnew_5_3_steps.ini',
            'administrator/language/de-LI/guidedtours.joomla_whatsnew_5_4.ini',
            'administrator/language/de-LI/guidedtours.joomla_whatsnew_5_4_steps.ini'
        ];
    }
