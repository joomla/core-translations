 ...
 * @copyright  (C) Translation 2008 - 2021 J!Club <https://www.joomlaclub.ch>
...
abstract class De_CHLocalise
{
	...
	public static function getIgnoredSearchWords()
	{
		...
		$search_ignore[] = "autor";
		$search_ignore[] = "aussen";
		$search_ignore[] = "ausser";
		$search_ignore[] = "ausserdem";
		$search_ignore[] = "ausserhalb";
		$search_ignore[] = "bald";
		...
		$search_ignore[] = "regelmässig";
		$search_ignore[] = "rief";
		$search_ignore[] = "rund";
		$search_ignore[] = "sang";
		$search_ignore[] = "sangen";
		$search_ignore[] = "schlechter";
		$search_ignore[] = "schliesslich";
